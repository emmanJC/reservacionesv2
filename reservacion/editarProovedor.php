    ...
    <div class="col-lg-12">
        <div class="card  ">
									<div class="card-header">
										<h2 class="card-title">Editar proovedor</h2>
                                         
                                        <div class="btn-group d-flex  pull-right" role="group">
                                            <a href="?seccion=reservacion&accion=listaProovedores" class="btn btn-secondary mr-1"> <i class="fa-solid fa-arrow-left"></i> Volver a proovedores</a> 
                                            <a class="btn btn-success text-rigth" href="./?seccion=reservacion&accion=altaMenu"><i class="fa-solid fa-plus" aria-hidden="true"></i> Agregar menú</a>                        
                                        </div>
									...
									<div class="card-body"> 
                                            ...
                                            <div class="form-group row pb-2 justify-content-center align-items-center">
                                                ...
                                                <div class="form-group row pb-2 justify-content-center align-items-center">
                                                    ...
                                                    <div class="col-xl-6 col-lg-8 px-lg-0">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control form-control-sm" name="direccion" placeholder="MONITOREO Y VALIDACIÓN DE..." required>
                                                            <span class="input-group-text">
                                                ...
                                                <div class="form-group row pb-2 justify-content-center align-items-center">
                                                    ...
                                                    <div class="col-xl-6 col-lg-8 px-lg-0">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control form-control-sm" name="pagina" placeholder="MONITOREO Y VALIDACIÓN DE..." required>
                                                            <span class="input-group-text">
